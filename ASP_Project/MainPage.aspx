...
<body>
    ...
    <asp:GridView ID="NoteGrid" GridLines="None"  runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataKeyNames="Sid" DataSourceID="SqlDataSource1"  BorderColor="#CC9966" CellPadding="15" >
                <Columns>
                    <asp:BoundField DataField="Sid" Visible="false" ReadOnly="True" SortExpression="Sid" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"  SelectCommandType="StoredProcedure" SelectCommand="Display_StickyNotes" OnSelecting="SqlDataSource2_Selecting" UpdateCommand ="Update_Notes" UpdateCommandType="StoredProcedure"
              DeleteCommandType="StoredProcedure" DeleteCommand="Delete_Note" > 
